...
def run_test(args, device):
    ...
    pre_model.load_state_dict(torch.load('model_stage1_epoch20.pth'), strict=False) #model_stage1_epoch20.pth can be downloaded through https://drive.google.com/file/d/1qly7uKTEvh_wVXHYvil-ZV0w3JUcAEHB/view?usp=drive_link
    #print(pre_model)
    in_channels = 32
    spatial_size = 23
