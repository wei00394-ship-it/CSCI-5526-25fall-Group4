...
mono_df.dropna(axis=1, how='any', inplace=True)
di_df.dropna(axis=1, how='any', inplace=True)
tri_df.dropna(axis=1, how='any', inplace=True)
tetra_df.dropna(axis=1, how='any', inplace=True)
ppseudoDNC_df.dropna(axis=1, how='any', inplace=True)
triplet_df.dropna(axis=1, how='any', inplace=True)
pseudo_struct_df.dropna(axis=1, how='any', inplace=True)
